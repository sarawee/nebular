...
function generateComponentsList(tree) {
    const componentsListFile = schematics_2.parseSourceFile(tree, COMPONENTS_LIST_FILE_PATH);
...
function getLazyModuleRoutes(tree, routingModuleDir, route) {
    ...
    if (lazyModule) {
        ...
        const moduleDirPath = core_1.dirname(utils_1.lazyModuleImportToFilePath(lazyModuleImport));
