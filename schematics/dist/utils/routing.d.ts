...
export declare function generateLazyModuleImport(from: Path, to: Path, moduleClassName: string): string;
/**
...
export declare function lazyModulePredicate(lazyModuleImport: string, route: ts.ObjectLiteralExpression): boolean;
